...
import cn.jeeweb.core.common.mapper.SelectMapper;
...
public class DataGridTag extends AbstractGridHtmlTag {
	...
	private SelectMapper selectMapper = new SelectMapper();
	...
	public void putColumnDictBySql(String dict,String selectSql) {
		columnDictMap.put(dict, selectMapper.selectBySql(selectSql));
	}
